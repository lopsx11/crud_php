                                    ...
                                    <?php foreach($_SESSION['pessoas'] as $pessoa): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="index.php?acao=deletar&id=<?php echo $pessoa['id']; ?>"class="delete" onclick="return confirm('Tem certeza que deseja excluir essa pessoa?');">Deletar</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                  <?php endif; ?>
